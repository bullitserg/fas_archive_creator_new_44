...
dir_names_dict = {
    ...
    'protocol_fz44-ek-firstPartRequestProtocol': 'Протокол рассмотрения и оценки первых частей заявок',
    'protocol_fz44-kou-firstPartRequestProtocol': 'Протокол рассмотрения и оценки первых частей заявок',
    'protocol_fz44-zk-requestProtocol': 'Протокол рассмотрения и оценки заявок',
    'protocol_fz44-zp-requestReviewProtocol': 'Протокол проведения запроса предложений',
    'protocol_fz44-zp-finalRequestProtocol': 'Протокол подведения итогов ',

    'features_JB2149': 'Декларация по статье 14 № 44-ФЗ (применение национального режима)',
...
document_dirs = {'s223:///': '/upl/srv/www/sectionks-archive/data/upload/',
                 ...
                 'local:///': '/upl/srv/www/44/data/procedure44/',
